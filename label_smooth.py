...
if __name__ == '__main__':
    ...
    net1 = nn.Sequential(nn.Conv2d(3, 3, kernel_size=3, stride=2, padding=1))
    net1.train()
    net2 = nn.Sequential(nn.Conv2d(3, 3, kernel_size=3, stride=2, padding=1))
    net2.train()

    with torch.no_grad():
        inten = torch.randn(2, 3, 5, 5)
        lbs = torch.randint(0, 3, [2, 5, 5])
        lbs[1, 3, 4] = 255
        lbs[1, 2, 3] = 255
        print(lbs)
